...
public class MainActivity extends AppCompatActivity {
    ...
    String[] country = {"ALL", "DZD", "USD", "XCD", "ADA", "ARS", "AMD", "AWG", "AUD", "AZN", "BSD", "BHD", "BDT", "BBD", "BYN", "BZD", "XOF", "BMD", "INR", "BTN", "BOB", "BOV", "BAM", "BWP", "NDK"}; //TODO
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConvert) {
        ...
        String url = "https://free.currconv.com/api/v7/convert?q=" + convertFrom + "_" + convertTo + "&compact=ultra&apiKey=a9a4a20d19013764d99f";
